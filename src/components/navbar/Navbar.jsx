    ...
    return (
        ...
        <>
            <motion.nav
                ...
                className='fixed top-0 z-[100] w-full hidden  items-center justify-between  px-8 py-3 lg:flex bg-tranparent backdrop-blur-md'>
            ...
            {/* Mobile Navbar */}
            <div className='fixed top-0 z-[100] w-full p-4 lg:hidden bg-tranparent backdrop-blur-md'>

                {/* Logo */}
                <NavLogo />

                <button className='absolute right-4 top-6 text-secondary-400' onClick={() => setIsOpen(true)}>
                ...
                {isOpen &&
                    ...
                    >
                        ...
                        <div className='flex justify-center items-center my-8'>
                            ...
                            <button className='inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium h-9 px-4 py-2 bg-primary text-white hover:border-primary/90'>
